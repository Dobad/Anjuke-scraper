...
print('''This program is to scrape XinFang data from Anjuke.com. 
...
Also be aware that there is a maximum of 3000 items in XinFang section with no more than 60 items each page, which means there're only 50 pages at most. 
''')
